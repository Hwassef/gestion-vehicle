...
<body>
    ...
    <div class="container">
        <div class="d-flex justify-content-end">
            <button class="btn btn-primary rounded-pill" id="showForm"><i class="fas fa-user-plus fa-1x"></i> Add Vehicle Type</button>
        </div>
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button type="submit" class="edit btn btn-dark" data-toggle="modal" data-target="#Modify" data-id="{{$VehicleType -> id}}">Edit</button>
                        <button type="submit" data-toggle="modal" data-target="#deleteModal" data-id="{{$VehicleType -> id}}" class="open-DeleteVehicleTypeDialog btn btn-dark">Delete</button>
                    </td>
                    @endforeach
                </tr>
            </tbody>
        ...
        <form method="POST" action="{{route('admin.addVehicleType')}}" enctype="multipart/form-data" id="addExternalAdmin" style="display: none; transition-timing-function: ease-in;" class="hide mt-5">
            @csrf
            <div class="row mt-3">
                <div class="col-2">
            ...
            <div class="row mt-3">
                ...
                <div class="col">
                    <input type="text" class="form-control col-md-6" name="tarif">
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    <form method="POST" action="{{route('admin.deleteVehicleType')}}">
                        @csrf
                        <input type="hidden" name="toDeleteVehicleTypeId" id="toDeleteVehicleTypeId">
    ...
    <div class="modal fade" id="Modify">
        <div class="modal-dialog" role="document">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    <form action="{{route('admin.updateVehicleType')}}" method="post">
                        @csrf
                        ...
                        <div class="modal-body">
                            <p style="letter-spacing: 7px; font-size: 22px;" class="text-center">EDIT</p>
                            <div class="row">
                                <div class="col-5">
                                    <label for="name">Vehicle Type Name :</label>
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control" id="name" name="vehicle_type_name">
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-5">
